...
; Check sprintf(dst, format, ...) -> __small_sprintf(str, format, ...) if no fp128.

define void @test_simplify7(i8* %dst) {
; CHECK-SMALL-PRINTF-LABEL: @test_simplify7(
  %fmt = getelementptr [3 x i8], [3 x i8]* @percent_f, i32 0, i32 0
  call i32 (i8*, i8*, ...) @sprintf(i8* %dst, i8* %fmt, double 1.87)
; CHECK-SMALL-PRINTF-NEXT: call i32 (i8*, i8*, ...) @__small_sprintf(i8* %dst, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @percent_f, i32 0, i32 0), double 1.870000e+00)
  ret void
...
define void @test_no_simplify3(i8* %dst) {
; CHECK-SMALL-PRINTF-LABEL: @test_no_simplify3(
  %fmt = getelementptr [4 x i8], [4 x i8]* @percent_Lf, i32 0, i32 0
  call i32 (i8*, i8*, ...) @sprintf(i8* %dst, i8* %fmt, fp128 0xLC0000000000000003FFFDEB851EB851E)
; CHECK-SMALL-PRINTF-NEXT: call i32 (i8*, i8*, ...) @sprintf(i8* %dst, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @percent_Lf, i32 0, i32 0), fp128 0xLC0000000000000003FFFDEB851EB851E)
  ret void
; CHECK-SMALL-PRINTF-NEXT: ret void
}
